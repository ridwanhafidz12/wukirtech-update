        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <MotionCard>
            <div className="aspect-w-16 aspect-h-10">
              <img  class="object-cover w-full h-full" alt="Tim WukirTech berdiskusi dengan pelaku UMKM di Wukirsari" src="https://images.unsplash.com/photo-1494171639056-44b7fcf5a767" />
            </div>
          </MotionCard>
