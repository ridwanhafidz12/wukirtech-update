...
const InteractiveMap = () => {
    ...
    const locations = [
        { pos: [-7.9155, 110.4280], name: "Batik Tulis Giriloyo", type: "Kerajinan", desc: "Pusat batik tulis legendaris dengan ratusan pengrajin." },
        { pos: [-7.8990, 110.4201], name: "Kerajinan Wayang Kulit Pucung", type: "Kerajinan", desc: "Lihat langsung pembuatan wayang kulit oleh para empu." },
        { pos: [-7.9080, 110.4355], name: "Wisata Watu Gagak", type: "Alam", desc: "Nikmati pemandangan matahari terbenam dari puncak bukit." },
