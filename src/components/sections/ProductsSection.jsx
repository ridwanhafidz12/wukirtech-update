...
const products = [
  ...
  },
  {
    ...
    imageUrl: "https://horizons-cdn.hostinger.com/73e774d8-1f03-44b2-ba9c-4491a99e3f2f/ce4c5bf46eb068149ecc1a2df28da12b.jpg",
    isNew: true,
  },
  {
      ...
      <Tabs defaultValue="whatsapp" className="w-full mt-4">
        ...
        <TabsContent value="qris" className="mt-4 p-4 bg-secondary/50 rounded-lg text-center">
          ...
          <div className="flex justify-center">
            <img  class="w-48 h-48 bg-gray-300 rounded-md" alt="Contoh kode QRIS untuk pembayaran" src="public/qris.jpg" />
          </div>
